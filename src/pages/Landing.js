...
const Landing = () => {
  ...
  return (
    <div className="border-border border-4 border-solid h-auto sm:h-screen w-full flex flex-col items-center justify-between p-0 sm:p-2 ">
      <Header />
      <div className="h-2/3 mt-4 p-0  px-0 sm:pl-6 flex flex-col sm:flex-row items-center justify-between w-11/12">
        ...
        <div className="flex justify-evenly  items-center w-full  h-96 sm:w-1/2 sm:h-full overflow-hidden">
          <img
            style={{ height: "90%" }}
            className="h-full transform translate-x-32  w-full"
            src={img}
            alt=""
          />
        </div>
