...
function SignInCont({
  ...
  return (
    <div className="bg-white sm:bg-opacity-95  pt-8 sm:pt-2 p-3 h-auto w-full bottom-0 left-0 top-0 fixed flex flex-col justify-center items-center z-50 font-Poppins">
      <div className=" content relative  border-white h-auto lg:h-4/5  text-white  w-full lg:w-1080 xl:w-2/3">
        ...
        <div className=" flex flex-col lg:grid gap-0 sm:grid-cols-5 w-full h-full ">
          <div className="  bg-primary w-full rounded-3xl  mb-4 sm:mb-0 sm:rounded-l-3xl sm:rounded-r-3xl lg:rounded-r-none xl:w-full sm:rounded-none col-span-2 p-2 sm:p-5 sm:pr-10 relative flex flex-col  items-center  h-44 sm:h-72  md:h-72 lg:h-full">
