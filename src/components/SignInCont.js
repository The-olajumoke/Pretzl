  ...
  return (
    <div className="bg-white sm:bg-opacity-95  pt-8 sm:pt-2 p-3 h-auto w-full bottom-0 left-0 top-0 fixed flex flex-col justify-center items-center z-50 font-Poppins">
      <div className="content relative  border-white h-auto lg:h-4/5  text-white flex flex-col lg:grid gap-0 sm:grid-cols-5 w-full">
        ...
        <div className=" bg-primary w-full rounded-3xl  mb-4 sm:mb-0 sm:rounded-l-3xl sm:rounded-none col-span-2 p-2 sm:p-5 sm:pr-10 relative flex flex-col  items-center  h-44 sm:h-80  lg:h-auto">
          <div className=" w-full flex flex-col justify-between h-full text-left sm:h-full p-7 sm:py-4">
            ...
            <div className=" h-full flex flex-col justify-evenly">
              ...
              {extraText ? (
                <h5 className=" leading-8 text-sm sm:text-lg  font-thin">{extraText}</h5>
              ) : (
